...
function App() {
  ...
  const findTransaction = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/transaction/findTransaction",
        {
  ...
  const findBlock = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/block/findblock",
        {
          block: "block",
        }
      );
  ...
  const BlockInfo = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/block",
        {
          block: "blockInfo",
        }
      );
  ...
  const TransactionInfo = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/transaction",
        {
  ...
  const BlocksdetailInfo = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/block/blocksdetailInfo",
  ...
  const TransactionsdetailInfo = async () => {
    try {
      const data = await axios.post(
        "http://etherscan.ssm.block7.errorcode.help/api/transaction/transactionsdetailInfo",
